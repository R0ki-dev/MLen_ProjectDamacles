...
@export var input_left : String = "Move Left"
## Name of Input Action to move Right.
@export var input_right : String = "Move Right"
## Name of Input Action to move Forward.
@export var input_forward : String = "Move Forward"
## Name of Input Action to move Backward.
@export var input_back : String = "Move Backward"
